...
import org.seguritech.cp.config.audit.AuditEventConverter;
import org.seguritech.cp.domain.PersistentAuditEvent;
...
import static org.seguritech.cp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
